        ...
        <div class="nTilesWrapper" id="{$TileGroupID}">
            ...
            <xsl:if test="ddwrt:IfHasRights(4)">
                <span class="nTileAdminLinks">
                    <b>actions</b>:&#160;<a href="#" title="add a tile" onclick="nSPTiles.addOrMoveTile(this, 'New', '{$TileGroupID}'); return false">add</a>&#160;|&#160;<a href="#" title="move a tile" onclick="nSPTiles.moveCloneEditOrDeleteTile(this, 'Update', '{$TileGroupID}'); return false">move</a>&#160;|&#160;<a href="#" title="clone a tile" onclick="nSPTiles.moveCloneEditOrDeleteTile(this, 'New', '{$TileGroupID}'); return false;">clone</a>&#160;|&#160;<a href="#" title="edit a tile" onclick="nSPTiles.moveCloneEditOrDeleteTile(this, 'Edit', '{$TileGroupID}'); return false;">edit</a>&#160;|&#160;<a href="#" title="delete a tile" onclick="nSPTiles.moveCloneEditOrDeleteTile(this, 'Delete', '{$TileGroupID}'); return false;">delete</a>&#160;|&#160;<a href="{$ListUrlDir_FALSE}?FilterField1=LinkTitle&amp;FilterValue1={$GroupName}" title="open the list in a new window" target="_blank">list</a>
                </span>
            </xsl:if>
            <!-- render tiles -->
            <xsl:choose>
